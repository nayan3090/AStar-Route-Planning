...
bool RoutePlanner::Compare(RouteModel::Node const *node1, RouteModel::Node const *node2)
    {
        float node1f = node1->g_value + node1->h_value;
        float node2f = node2->g_value + node2->h_value;
